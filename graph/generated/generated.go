...
type MutationResolver interface {
	AddEmployee(ctx context.Context, input model.NewEmployee) (*model.Employee, error)
}
...
var sources = []*ast.Source{
	{Name: "graph/schema.graphqls", Input: `type Employee {
  id: ID!
  name: String!
  age: Int!
  salary: Float!
...
func (ec *executionContext) field_Mutation_addEmployee_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewEmployee2graphqlᚑserverᚋgraphᚋmodelᚐNewEmployee(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Employee_age(ctx context.Context, field graphql.CollectedField, obj *model.Employee) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Employee_address(ctx context.Context, field graphql.CollectedField, obj *model.Employee) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNAddress2ᚖgraphqlᚑserverᚋgraphᚋmodelᚐAddress(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_addEmployee(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().AddEmployee(rctx, args["input"].(model.NewEmployee))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNEmployee2ᚖgraphqlᚑserverᚋgraphᚋmodelᚐEmployee(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_employees(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Employee)
	fc.Result = res
	return ec.marshalNEmployee2ᚕᚖgraphqlᚑserverᚋgraphᚋmodelᚐEmployeeᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNAddress2ᚖgraphqlᚑserverᚋgraphᚋmodelᚐAddress(ctx context.Context, sel ast.SelectionSet, v *model.Address) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalNEmployee2graphqlᚑserverᚋgraphᚋmodelᚐEmployee(ctx context.Context, sel ast.SelectionSet, v model.Employee) graphql.Marshaler {
	return ec._Employee(ctx, sel, &v)
}

func (ec *executionContext) marshalNEmployee2ᚕᚖgraphqlᚑserverᚋgraphᚋmodelᚐEmployeeᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Employee) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNEmployee2ᚖgraphqlᚑserverᚋgraphᚋmodelᚐEmployee(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNEmployee2ᚖgraphqlᚑserverᚋgraphᚋmodelᚐEmployee(ctx context.Context, sel ast.SelectionSet, v *model.Employee) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNNewEmployee2graphqlᚑserverᚋgraphᚋmodelᚐNewEmployee(ctx context.Context, v interface{}) (model.NewEmployee, error) {
